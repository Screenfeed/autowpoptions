...
function init_test_suite( $test_suite = 'Unit' ) {
	...
	require_once AUTOWPOPTIONS_ROOT . '/vendor/autoload.php';
	...
	require_once AUTOWPOPTIONS_ROOT . '/vendor/antecedent/patchwork/Patchwork.php';
}
...
function check_readiness() {
	if ( version_compare( phpversion(), '7.1.0', '<' ) ) {
		trigger_error( 'AutoWPOptions Unit Tests require PHP 7.1 or higher.', E_USER_ERROR ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_trigger_error -- Valid use case for our testing suite.
	}
...
function init_constants( $test_suite_folder ) {
	define( 'AUTOWPOPTIONS_ROOT', dirname( __DIR__ ) . DIRECTORY_SEPARATOR );
	define( 'AUTOWPOPTIONS_TESTS_ROOT', __DIR__ . DIRECTORY_SEPARATOR . $test_suite_folder . DIRECTORY_SEPARATOR );
